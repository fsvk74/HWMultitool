...
options=("Get info about phone" "FI Flash Program" "FI Unlock Program" "Deleter" "PowerGenue" "EMUI Tweaker" "Samsung Flash Program" "Setup Program" "Addons" "Exit")
